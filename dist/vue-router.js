...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libRouteRecognizer = __webpack_require__(3);
	...
	var _override = __webpack_require__(9);
	...
	var Router = (function () {
	  function Router() {
	    ...
	    // route recognizer
	    this._recognizer = new _libRouteRecognizer2['default']();
	    this._guardRecognizer = new _libRouteRecognizer2['default']();
	  ...
	  */
	  ...
	  Router.prototype.start = function start(App, container, cb) {
	    ...
	    if (this._historyFallback) {
	      ...
	      var _history = new _historyHtml52['default']({ root: this._root });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dsl = __webpack_require__(7);
	...
	var oCreate = _Object$create || function (proto) {
	  function F() {}
	  F.prototype = proto;
	  return new F();
	};
	...
	RouteRecognizer.prototype.map = _dsl2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var genQuery = _libRouteRecognizer2['default'].prototype.generateQueryString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$freeze = __webpack_require__(11)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pipeline = __webpack_require__(23);
	...
	var RouteTransition = (function () {
	  ...
	  RouteTransition.prototype.start = function start(cb) {
	    ...
	    for (i = 0; i < reverseDeactivateQueue.length; i++) {
	      if (!_pipeline.canReuse(reverseDeactivateQueue[i], activateQueue[i], transition)) {
	        break;
	      }
	    }
	    if (i > 0) {
	    ...
	    // 2. Validation phase
	    transition.runQueue(deactivateQueue, _pipeline.canDeactivate, function () {
	      transition.runQueue(activateQueue, _pipeline.canActivate, function () {
	        transition.runQueue(deactivateQueue, _pipeline.deactivate, function () {
	          // 3. Activation phase
	          ...
	          reuseQueue && reuseQueue.forEach(function (view) {
	            return _pipeline.reuse(view, transition);
	          });
	          ...
	          if (deactivateQueue.length) {
	            ...
	            _pipeline.activate(_view, transition, depth, cb);
	          } else {
	            cb();
	          }
	        });
